...
# Keep constructors (mail-related classes are often created via reflection)
...
# Avoid removing mailcap-related configuration (some MIME type registrations)
-dontoptimize
-dontshrink
...
# Keep junixsocket related classes to avoid breaking reflection/native calls
